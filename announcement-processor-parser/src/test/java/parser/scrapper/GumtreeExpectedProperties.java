...
class GumtreeExpectedProperties {
    ...
    static String expectedPhoneNumberNotExists = null;
    static String expectedPhoneNumberExists = "795002620";
    static String expectedPropertyType = "Mieszkanie";
    static Double expectedFlatArea = 40d;
    static Integer expectedRoomAmount = 1;
    static Integer expectedBathAmount = 1;
    static String expectedParking = "Ulica";
    static Boolean expectedSmokers = true;
    static Boolean expectedPetFriendly = false;

    static String expectedDescription = "Proponuję mieszkanie na wynajem (kawalerka) o powierzchni 40m2 zlokalizowane przy ulicy Głowackiego 4 w Krakowie. Dzielnica Krowodrza. Rejon Bronowice.\n" +
            "\n" +
